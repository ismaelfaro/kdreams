...
@click.option("--non-interactive", "-y", "non_interactive", is_flag=True, default=False,
              help="Never prompt; auto-pick defaults for quantized-variant selection.")
def generate(repo, output, publish, fmt, target_arch, non_interactive):
